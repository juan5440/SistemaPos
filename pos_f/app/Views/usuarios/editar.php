                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <label>Usuario</label>
                            <input class="form-control" type="text" name="usuario" id="usuario" value="<?php echo $datos['usuario'];?>" autofocus required />
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <select class="form-control" id="id_caja" name="id_caja" required>
                                ...
                                <?php foreach ($cajas as $caja) {?>
                                    <option value="<?php echo $caja['id']; ?>" <?php if($datos['id'] == $datos['id_caja']) { echo 'selected';}?>><?php echo $caja['nombre']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <select class="form-control" id="id_rol" name="id_rol" required>
                                ...
                                <?php foreach ($roles as $rol) {?>
                                    <option value="<?php echo $rol['id']; ?>" <?php if($datos['id'] == $datos['id_rol']) { echo 'selected';}?>><?php echo $rol['nombre']; ?></option>
                                <?php } ?>
                            </select>                       
                        </div>
                    </div>
