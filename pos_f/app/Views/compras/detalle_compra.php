<div id="layoutSidenav_content">
    <main>
        ...
        <div class="container-fluid">
            <h4 class="mt-4"><?php echo $titulo;?></h4>
             <a href="<?php echo base_url();?>/compras/inprimir" class="btn btn-danger" title="Exporta todos los registos" ><i class="fas fa-file-pdf"></i></a>
    ...
    // Specify file name
    filename = filename?filename+'.xls':'R_compra.xls';
