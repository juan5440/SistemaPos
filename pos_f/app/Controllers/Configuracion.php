...
class Configuracion extends BaseController
{
	...
	public function index($activo = 1){
		...
		$data = ['titulo' => 'Configuración', 'nombre' => $nombre, 'rfc' => $rfc, 'telefono' => $telefono, 
...
public function actualizar()
{
	...
	$validacion = $this->validate([
		'tienda_logo' =>[
			...
			'max_size[tienda_logo, 5096]'
		]
	]);

	if($validacion){

		$ruta_logo = "imagenes/logotipo.png";
		...
		if(file_exists($ruta_logo)){
			...
			$img->move('./imagenes', 'logotipo.png');
	}else{
