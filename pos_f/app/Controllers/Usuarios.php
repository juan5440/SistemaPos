...
class Usuarios extends BaseController
{
	...
	public function __construct()
	{
		...
		'repassword' => [
			...
			'errors' => [
				'required' => 'El campo {field} es obligatorio.',
				'matches' => 'Las contraceñas no coinciden.'
			]
		],
		'nombre' => [
			'rules' => 'required',
	...
	public function nuevo()
	{
		...
		echo view('header');
		echo view('usuarios/nuevos', $data);
		echo view('footer');
	}
...
public function canbia_password(){
		$session = session();
		$usuario = $this->usuarios->where('id', $session->id_usuario)->first();
		$data = ['titulo' => 'Cambiar contraseñas', 'usuario' => $usuario];
		echo view('header');
		echo view('usuarios/canbia_password', $data);
		echo view('footer');
}
public function actualizar_password(){
		...
		$usuario = $this->usuarios->where('id', $session->id_usuario)->first();
		$data = ['titulo' => 'Cambiar contraseñas', 'usuario' => $usuario, 'mensaje' => 'Contraseña actualizada'];
		echo view('header');
		echo view('usuarios/canbia_password', $data);
		echo view('footer');
	}
		...
		$session = session();
		$usuario = $this->usuarios->where('id', $session->id_usuario)->first();
		$data = ['titulo' => 'Cambiar contraseñas', 'usuario' => $usuario, 'validation' => $this->validator];
		echo view('header');
		echo view('usuarios/canbia_password', $data);
		echo view('footer');
	}
