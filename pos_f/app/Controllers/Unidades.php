...
class Unidades extends BaseController
{
	...
	public function nuevo()
	{
		...
		echo view('header');
		echo view('unidades/nuevos', $data);
		echo view('footer');
	}
...
{
	if ($this->request->getMethod() == "post" && $this->validate($this->reglas)){
	$this->unidades->update($this->request->getPost('id'), ['nombre' => $this->request->getPost('nombre'), 'nombre' => $this->request->getPost('nombre'), 'nombre_corto' => 
		$this->request->getPost('nombre_corto')]);
	return redirect()->to(base_url().'/unidades');
	}else{
